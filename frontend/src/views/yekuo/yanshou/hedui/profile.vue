<template>
  <div class="profile">
    ...
    <van-field v-model="data.yyyxrl" label="原有运行容量" placeholder="请输入原有运行容量kVA" />
    <van-field v-model="data.zjrl" label="增加容量" placeholder="请输入增加容量kVA" />
    <van-field v-model="data.zjhhtrl" label="增加后合同容量" placeholder="请输入增加后合同容量kVA" />
    <van-field
