<template>
  <div class="nameplate">
    <van-field v-model="data.cjmc" :readonly="true" label="厂家名称" placeholder="请输入厂家名称" />
    <van-field v-model="data.ccbh" :readonly="true" label="出厂编号" placeholder="请输入出厂编号" />
    <TimePicker
      label="出厂日期"
      :readonly="true"
      placeholder="选择出厂日期"
    ...
    <Picker
      ...
      @res="eccdyConfirm"
    ></Picker>
    <van-field v-model="data.syzq" :readonly="true" label="实验周期" placeholder="请输入实验周期" />
    <Picker
      :columns="eddygycols"
      :readonly="true"
      required="1"
    ...
    <Picker
      ...
      @res="eddldyConfirm"
    ></Picker>
    <van-field v-model="data.dlzk" :readonly="true" label="短路阻抗" placeholder="请输入短路阻抗" />
    <van-field v-model="data.yh" :readonly="true" label="油号" placeholder="请输入油号" />
    <van-field v-model="data.jddz" :readonly="true" label="接地电阻" placeholder="请输入接地电阻" />
    <Picker
      :columns="bhfscols"
      :readonly="true"
      required="1"
    ...
    <Picker
      ...
      @res="kzdlConfirm"
    ></Picker>
    <van-field v-model="data.fjtdc" :readonly="true" label="分接头档次" placeholder="请输入分接头档次" />
    <van-field v-model="data.fjtwz" :readonly="true" label="分接头位置" placeholder="请输入分接头位置" />
    <Picker
    ...
    <Picker
      ...
      @res="lqfsConfirm"
    ></Picker>
    <van-field v-model="data.kz" :readonly="true" label="K值" placeholder="请输入K值" />
    <Picker
      :columns="dqzjxfscols"
      :readonly="true"
      required="1"
